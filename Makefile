...
PACKAGE ?= helm-ollama
XRD_DIR := apis/ollamas
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
EXAMPLE_DEFAULT := examples/ollamas/standard.yaml
...
EXAMPLES := \
    examples/ollamas/minimal.yaml:: \
    examples/ollamas/standard.yaml::
